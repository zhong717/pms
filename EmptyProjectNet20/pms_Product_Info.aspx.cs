...
{
    public partial class pms_Product_Info : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            ds = m_bllpms_Product_Batch.GetList(strWhere);
            // 在查询添加之后，排序和分页之前获取总记录数
            // Grid1总共有多少条记录
            Grid1.RecordCount = ds.Tables[0].Rows.Count;

            ds = m_bllpms_Product_Batch.GetList(Grid1.PageSize, Grid1.PageIndex + 1, strWhere);
