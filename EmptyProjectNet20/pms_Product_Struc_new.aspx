<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pms_Product_Struc_new.aspx.cs" Inherits="EmptyProjectNet20.pms_Product_Struc_new" %>
...
<body>
    ...
    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            <x:TextBox ID="tbxName" runat="server" Label="产品结构" Required="true" ShowRedStar="true"></x:TextBox>
        </Items>
    </x:SimpleForm>
    </form>
</body>
