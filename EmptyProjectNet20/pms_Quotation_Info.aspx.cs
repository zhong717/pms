...
{
    public partial class pms_Quotation_Info : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            string strWhere = " 审批状态='待生产部审批' or 审批状态='待报价'";
            if (!String.IsNullOrEmpty(searchText))
            {
                strWhere = " (审批状态='待生产部审批' or 审批状态='待报价') and 批次名称 like '%" + searchText + "%'";
            }
