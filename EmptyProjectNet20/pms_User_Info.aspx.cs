...
{
    public partial class pms_User_Info : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("~/pms_User_Info_new.aspx", "添加新用户");
        ...
        private void BindGrid()
        {
            ...
            {
                strWhere = "UserName = '" + searchText + "'";
            }

            ds = m_bllpms_User_Info.GetList(strWhere);
            // 在查询添加之后，排序和分页之前获取总记录数
            // Grid1总共有多少条记录
             Grid1.RecordCount = ds.Tables[0].Rows.Count;

            ds = m_bllpms_User_Info.GetList(Grid1.PageSize,Grid1.PageIndex + 1,strWhere);
