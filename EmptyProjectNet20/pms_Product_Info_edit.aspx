<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pms_Product_Info_edit.aspx.cs" Inherits="EmptyProjectNet20.pms_Product_Info_edit" %>
...
<body>
    ...
    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            ...
            <x:FileUpload ID="fileUpload" runat="server" Label="附件" EmptyText="多个附件请打包为一个上传"></x:FileUpload>
            <x:Button ID="btnDownload" runat="server" Text="下载附件" OnClick="btnDownload_Click"></x:Button>
        </Items>
    </x:SimpleForm>
    </form>
</body>
