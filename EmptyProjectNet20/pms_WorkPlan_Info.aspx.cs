...
{
    public partial class pms_WorkPlan_Info : System.Web.UI.Page
    {
        ...
        {
            btnNew.OnClientClick = Window1.GetShowReference("~/pms_WorkPlan_Info_new.aspx","添加工作计划");
        ...
        private void BindGrid()
        {
            ...
            {
                strWhere = "批次名称 like '%" + searchText + "%'";
            }

            ds = m_bllpms_OutAssistance_WorkPlan.GetList(strWhere);
            // 在查询添加之后，排序和分页之前获取总记录数
            // Grid1总共有多少条记录
            Grid1.RecordCount = ds.Tables[0].Rows.Count;

            ds = m_bllpms_OutAssistance_WorkPlan.GetList(Grid1.PageSize, Grid1.PageIndex + 1, strWhere);
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                try
                {
                    ...
                    m_bllpms_OutAssistance_WorkPlan.Delete(id);
                    BindGrid();
