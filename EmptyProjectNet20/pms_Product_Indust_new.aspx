<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pms_Product_Indust_new.aspx.cs" Inherits="EmptyProjectNet20.pms_Product_Indust_new" %>
...
<body>
    ...
    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            <x:TextBox ID="tbxName" runat="server" Label="所在行业" Required="true" ShowRedStar="true"></x:TextBox>
        </Items>
    </x:SimpleForm>
    </form>
</body>
