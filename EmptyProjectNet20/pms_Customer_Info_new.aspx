<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pms_Customer_Info_new.aspx.cs" Inherits="EmptyProjectNet20.pms_Customer_Info_new" %>
...
<body>
    ...
    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            <x:TextBox ID="tbxType" runat="server" Label="顾客类型" Required="true" ShowRedStar="true"></x:TextBox>
            <x:TextBox ID="tbxName" runat="server" Label="顾客名称" Required="true" ShowRedStar="true"></x:TextBox>
        </Items>
    </x:SimpleForm>
    </form>
</body>
