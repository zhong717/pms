...
{
    public partial class pms_Machine_Info : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("~/pms_Machine_Info_new.aspx", "添加新机床");
        ...
        private void BindGrid()
        {
            ...
            {
                strWhere = "DeviceType like '%" + searchText + "%'";
            }

            ds = m_bllpms_Machine_Price.GetList(strWhere);
            // 在查询添加之后，排序和分页之前获取总记录数
            // Grid1总共有多少条记录
            Grid1.RecordCount = ds.Tables[0].Rows.Count;

            ds = m_bllpms_Machine_Price.GetList(Grid1.PageSize, Grid1.PageIndex + 1, strWhere);
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                try
                {
                    ...
                    m_bllpms_Machine_Price.Delete(id);
                    BindGrid();
