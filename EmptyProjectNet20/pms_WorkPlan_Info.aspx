<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pms_WorkPlan_Info.aspx.cs" Inherits="EmptyProjectNet20.pms_WorkPlan_Info" %>
                ...
                <Toolbars>
                    <x:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                            ...
                            <x:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="添加计划">
                            </x:Button>
                        </Items>
                    </x:Toolbar>
                </Toolbars>
                <Columns>
                    <x:BoundField DataField="PlanMonth" SortField="PlanMonth" ExpandUnusedSpace="true" HeaderText="计划月份" />
