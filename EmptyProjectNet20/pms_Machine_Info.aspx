<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pms_Machine_Info.aspx.cs" Inherits="EmptyProjectNet20.pms_Machine_Info" %>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="5px" EnableLargeHeader="false"
        ...
        <Items>
            ...
            <x:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                EnableRowNumber="true" DataKeyNames="MachinePriceID" AllowSorting="true"
                ...
                <Columns>
                    <x:BoundField DataField="DeviceType" SortField="机床类型" ExpandUnusedSpace="true" HeaderText="机床类型" />
                    <x:BoundField DataField="DeviceDescript" SortField="机床说明" ExpandUnusedSpace="true" HeaderText="机床说明" />
                    <x:BoundField DataField="InternalCost" SortField="内部成本" ExpandUnusedSpace="true" HeaderText="内部成本" />
                    <x:BoundField DataField="InternalPrice" SortField="内部价格" ExpandUnusedSpace="true" HeaderText="内部价格" />
                </Columns>
            </x:Grid>
        </Items>
    </x:Panel>
